...
<div class="left-side-bar">
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
					<a href="profile.php?id=<?php echo $employeeid; ?>" class="dropdown-toggle no-arrow active">
 ...
 -->
                     ...
                     ?>
							<h5 class="text-center h5 mb-0"><?php echo $fname. " ".$mname." ".$lname ?></h5>
							<p class="text-center text-muted font-14"><?php echo $empid ?></p>
